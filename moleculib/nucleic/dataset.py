...
class RNADataset(PreProcessedDataset):
    def __init__(
        self, datums, transform: List[Callable] = None, shuffle=True, train_split=0.9
    ):
        ...
        # get casp data:
        path_casp = (
            "/mas/projects/molecularmachines/db/PREPROCESSED/test_CASP_len_8.pkl"
        )
        # unpickle the data:
        ...
        # get rna art data:
        path_rna_art = (
            "/mas/projects/molecularmachines/db/PREPROCESSED/test_RNART1_len_27.pkl"
        )
