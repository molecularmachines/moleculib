...
base_atoms_per_nuc = OrderedDict(
    ...
    RT=[
        ...
        "C6",
        "C7",
    ],  # Calman Didn't have C5M  'C5' instead
    G=[
        "N1",
        "C2",
        "N2",
    ...
    DU=[
        ...
        "C5",
        "C6",
    ],  # mutagenic U (doesn't suppose to be a DNA nuc but RNA nuc)
)
...
backbone_atoms_DNA = [
    ...
    "O4'",
    "O5'",
]  # NOTE: add "" for carbons and Oxygens as in the file
backbone_atoms_RNA = [
    "P",
    "OP1",
    "OP2",
...
MAX_DNA_ATOMS = max(
    [len(atoms) for atoms in atoms_per_nuc.values()]
)  ###==24 ###NOTE MAYBE MORE? 31
...
def get_nucleotide_index(
    ...
    int
):  # get index straight from here to make sure UNK index is set to 13 and not 30.abs
    try:
